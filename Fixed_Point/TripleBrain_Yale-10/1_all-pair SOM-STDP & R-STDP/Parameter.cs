...
namespace PARAMETER
{
    class Parameter
    {
        ...
        all-pair model  
            som-stdp&rstdp: yale:4.0 
            som-r-stdp:     yale:1.0 
        nearest-pair model
            som-stdp&rstdp: yale:4.0
            som-r-stdp:     yale:1.0
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static int MembraneThreshold = (int)Math.Round(4.0 * (1 << FIXED_POINT_8));
        ...
        all-pair model  
            som-stdp&rstdp: yale:8.0
            som-r-stdp:     yale:0.5
        nearest-pair model
            som-stdp&rstdp: yale:8.0
            som-r-stdp:     yale:1.0 
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(8.0 * (1 << FIXED_POINT_8)); //0.5
        //NeuronSTDPTrace的各项参数

        /*--------------------PreSpike_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: yale:16
            som-r-stdp:     yale:16
        nearest-pair model
            som-stdp&rstdp: yale:200
            som-r-stdp:     yale:16
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  16;
        ...
        nearest-pair model
            ...
            som-r-stdp:     yale:16
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  16;

...
namespace SOM_RSTDP
{
    ...
    class Program
    {
        ...
        public static string ResultPath = "../../../../Result/nearest_pair SOM-STDP & RSTDP.txt";
        static void Main(string[] args)
        {
            Console.WriteLine("Hello World!");
            string pattern = Pattern[0]; //0: som-stdp & r-stdp  1: r-som-stdp
            ...
            for (int factor = 50; factor <= 150; factor++)  //SOM-STDP & R-STDP:50-120  R-SOM-STDP:50-150
            {

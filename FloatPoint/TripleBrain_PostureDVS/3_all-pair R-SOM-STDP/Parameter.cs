...
namespace PARAMETER
{
    class Parameter
    {
        ...
        public static int NumClass = 3;          //类别数 mnist:10 orl:10 yale:10 eth80:8 posture-dvs:3 cards-dvs:4
        ...
        nearest-pair model
            som-stdp&rstdp:     posture-dvs 1.0
            som-r-stdp: yale:   posture-dvs 1.0
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static double MembraneThreshold = 1.0; 
        public static double RestPotential = 0.0;
        public const int RefractionPeriod = 0;
        public const int SampleTimeWindow = 200;
        /*--------------------V_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp:   posture-dvs:200
            som-r-stdp:       posture-dvs:200
        nearest-pair model
            som-stdp&rstdp:   posture-dvs:200
            som-r-stdp:       posture-dvs:200
        /--------------------V_tao Config---------------------------------------*/
        ...
        all-pair model  
            som-stdp&rstdp: posture-dvs:1.5
            som-r-stdp:     posture-dvs:1.5
        nearest-pair model
            som-stdp&rstdp: posture-dvs:1.5
            som-r-stdp:     posture-dvs:1.5
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static double DynamicThreasholdAmount = 1.5;
        //NeuronSTDPTrace的各项参数  
        /*--------------------PreSpike_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: posture-dvs:400
            som-r-stdp:     posture-dvs:400
        nearest-pair model
              som-stdp&rstdp: posture-dvs:400
            som-r-stdp:     posture-dvs:400
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  400;  //nearest model: 100
        ...
        nearest-pair model
            ...
            som-r-stdp:     posture-dvs:400
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  400;  //nearest model:100

...
namespace PARAMETER
{
    class Parameter
    {
        ...
        /*--------------------V_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: nmnist:400
            som-r-stdp:     nmnist:200
        nearest-pair model
            som-stdp&rstdp: nmnist:400
            som-r-stdp:     nmnist:200
        /--------------------V_tao Config---------------------------------------*/
        public static double V_tao = 200; //200
        /*--------------------DynamicThreshold_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: nmnist:200
            som-r-stdp:     nmnist:200
        nearest-pair model
            som-stdp&rstdp: nmnist:200
            som-r-stdp:     nmnist:200
        ...
        all-pair model  
            som-stdp&rstdp: nmnist:16.0
            som-r-stdp:     nmnist:5.0
        nearest-pair model
            som-stdp&rstdp: nmnist:16.0
            som-r-stdp:     nmnist:5.0
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(16.0 * (1 << FIXED_POINT_8)); //15.5
        //NeuronSTDPTrace的各项参数

        /*--------------------PreSpike_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: nmnist:100
            som-r-stdp:     nmnist:100
        nearest-pair model
            som-stdp&rstdp: nmnist:100
            som-r-stdp:     nmnist:100(200)
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  100;
        ...
        nearest-pair model
            ...
            som-r-stdp:     nmnist:100(200)
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  100;

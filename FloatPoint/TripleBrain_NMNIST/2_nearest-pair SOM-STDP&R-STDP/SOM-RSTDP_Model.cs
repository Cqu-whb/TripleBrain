...
namespace SOM_RSTDPModel
{
    public static class Som_rstdpModel
    {
        ...
        all-pair model  
            som-stdp&rstdp: nmnist 3
            som-r-stdp:     nmnist 5
        nearest-pair model
            som-stdp&rstdp: nmnist 5
            som-r-stdp:     nmnist 5
        /--------------------r-stdp stage learning epoch---------------------------------------*/
        public static int RSTDP_EP = 3;
        ...
        //N-MNIST
        public const string TrainCodingSpikePath = Path + "nmnist_train_coding.txt";
        public const string TrainLabelPath = Path + "nmnist_train_label.txt";
        public const string TestCodingSpikePath = Path + "nmnist_test_coding.txt";
        public const string TestLabelPath = Path + "nmnist_test_label.txt";
        public static int ImageOffest = 2193;
        public static int TrainNum = 2193;
        public static int TestNum = 3745;
        public static int MNISTTrainNum = 21936;
        public static int MNISTTestNum = 3745;
                            ...
                            else if (LearnRule == "R_STDP")
                            {
                                for (int j = 0; j < Parameter.InputLayerNeurons; j++)
                                {
                                    ...
                                    if (InputClassLabel == Parameter.NeuronRelativeLabel[i])
                                    {
                                        ...
                                        all-pair model  
                                            som-stdp&rstdp: nmnist:1.0
                                            som-r-stdp:     nmnist:1.0
                                        nearest-pair model
                                            som-stdp&rstdp: nmnist:1.0
                                            som-r-stdp:     nmnist:1.0
                                        /--------------------post learning reward lr factor---------------------------------------*/

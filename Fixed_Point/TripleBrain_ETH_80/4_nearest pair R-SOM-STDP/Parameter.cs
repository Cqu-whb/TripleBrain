...
namespace PARAMETER
{
    class Parameter
    {
        ...
        nearest-pair model
            ...
            som-r-stdp:     eth80: 0.01 
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static int MembraneThreshold = (int)Math.Round(0.01 * (1 << FIXED_POINT_8));  //1.45
        ...
        nearest-pair model
            ...
            som-r-stdp:      eth80:0.5  
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(0.5 * (1 << FIXED_POINT_8));
        ...
        nearest-pair model
            ...
            som-r-stdp:      eth80:50  
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  50; //160

...
namespace PARAMETER
{
    class Parameter
    {
        ...
        public static int NumClass = 4;        //类别数 orl:10 yale:10 eth80:8 posture-dvs:3 cards-dvs:4 nmnist:10
        ...
        all-pair model  
            som-stdp&rstdp: cards-dvs:0.1 
            som-r-stdp:     cards-dvs:0.1 
        nearest-pair model
            som-stdp&rstdp: cards-dvs:0.1
            som-r-stdp:     cards-dvs:0.1
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static int MembraneThreshold = (int)Math.Round(0.1 * (1 << FIXED_POINT_8));
        ...
        /*--------------------V_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: cards-dvs:200
            som-r-stdp:     cards-dvs:200 
        nearest-pair model
            som-stdp&rstdp: cards-dvs:200 
            som-r-stdp:     cards-dvs:200 
        /--------------------V_tao Config---------------------------------------*/
        ...
        nearest-pair model
            ...
            som-r-stdp:      cards-dvs:0.1 
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(0.1 * (1 << FIXED_POINT_8));
        //NeuronSTDPTrace的各项参数
        /*--------------------PreSpike_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp:  cards-dvs:400
            som-r-stdp:      cards-dvs:400
        nearest-pair model
            som-stdp&rstdp:  cards-dvs:400
            som-r-stdp:      cards-dvs:400
        /--------------------PreSpike_tao Config---------------------------------------*/

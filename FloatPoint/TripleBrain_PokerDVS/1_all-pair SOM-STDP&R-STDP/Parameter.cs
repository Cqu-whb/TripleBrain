...
namespace PARAMETER
{
    class Parameter
    {
        ...
        public static int NumClass = 4;          //类别数 mnist:10 orl:10 yale:10 eth80:8 posture-dvs:3 cards-dvs:4
        ...
        nearest-pair model
            ...
            som-r-stdp:     cards-dvs:0.1
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static double MembraneThreshold = 0.1; 
        ...
        nearest-pair model
            ...
            som-r-stdp:      cards-dvs:0.1 
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static double DynamicThreasholdAmount = 0.1;

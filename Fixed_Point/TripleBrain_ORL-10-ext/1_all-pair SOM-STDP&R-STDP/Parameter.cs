...
namespace PARAMETER
{
    class Parameter
    {
        ...
        all-pair model  
            som-stdp&rstdp: orl: 10.0
            som-r-stdp:     orl: 8.0
        nearest-pair model
            som-stdp&rstdp: orl: 8.0
            som-r-stdp:     orl: 8.0
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(10.0 * (1 << FIXED_POINT_8));
        //NeuronSTDPTrace的各项参数

        /*--------------------PreSpike_tao Config---------------------------------------/
        all-pair model  
            som-stdp&rstdp: orl: 20
            som-r-stdp:     orl: 16
        nearest-pair model
            som-stdp&rstdp: orl: 16
            som-r-stdp:     orl: 16(200)
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  20;
        ...
        nearest-pair model
            ...
            som-r-stdp:     orl: 16
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  20;

...
namespace SOM_RSTDPModel
{
    public static class Som_rstdpModel
    {
                                ...
                                for (int j = 0; j < Parameter.InputLayerNeurons; j++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        all-pair model  
                                            ...
                                            som-r-stdp:     yale:7.25
                                        nearest-pair model
                                            som-stdp&rstdp: yale:8.25
                                            som-r-stdp:     yale:8.25
                                        /--------------------post learning punish lr factor--------------------------------------*/
        ...
        public static void SOMTrain(string pattern)
        {
            ...
            for (int externEp = 0; externEp < 50; externEp++) //mnist 1 orl 100 yale 50
            {
            ...
            //动态阈值衰减
            DynamicThreasholdScaling(64.0 / 256.0);  //som-stdp & r-stdp:64 r-som-stdp:32
            //记录动态阈值

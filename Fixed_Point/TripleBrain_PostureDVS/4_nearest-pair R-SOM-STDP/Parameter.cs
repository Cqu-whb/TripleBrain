...
namespace PARAMETER
{
    class Parameter
    {
        ...
        public static int NumClass = 3;        //类别数 orl:10 yale:10 eth80:8 posture-dvs:3 cards-dvs:4 nmnist:10
        ...
        nearest-pair model
            ...
            som-r-stdp:     posture-dvs:1.5
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(1.5 * (1 << FIXED_POINT_8));
        ...
        nearest-pair model
            ...
            som-r-stdp:     posture-dvs:400
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  400;
        ...
        nearest-pair model
            ...
            som-r-stdp:     posture-dvs:400
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  400;

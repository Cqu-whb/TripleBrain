...
namespace PARAMETER
{
    class Parameter
    {
        ...
        public static int NumClass = 8;        //类别数 orl:10 yale:10 eth80:8 posture-dvs:3 cards-dvs:4 nmnist:10
        ...
        all-pair model  
            som-stdp&rstdp: eth80: 1.45
            som-r-stdp:     eth80: 0.01 
        nearest-pair model
            som-stdp&rstdp: eth80: 1.5 
            som-r-stdp:     eth80: 0.01 
        /--------------------MembraneThreshold Config---------------------------------------*/
        public static int MembraneThreshold = (int)Math.Round(1.45 * (1 << FIXED_POINT_8));  //1.45
        ...
        nearest-pair model
            ...
            som-r-stdp:     eth80:20000
        /*--------------------DynamicThreshold_tao Config---------------------------------------*/
        public static double DynamicThreshold_tao = 20000; //20000
        //可以定义浮点的1 /tao
        ...
        nearest-pair model
            ...
            som-r-stdp:      eth80:0.5  
        /--------------------DynamicThreasholdAmount Config---------------------------------------*/
        public static int DynamicThreasholdAmount = (int)Math.Round(16.0 * (1 << FIXED_POINT_8));
        ...
        nearest-pair model
            ...
            som-r-stdp:      eth80:50  
        /--------------------PreSpike_tao Config---------------------------------------*/
        public static double PreSpike_tao  =  160; //160
        ...
        nearest-pair model
            ...
            som-r-stdp:      eth80:50 
        /--------------------PostSpike_tao Config---------------------------------------*/
        public static double PostSpike_tao =  10000; 

...
namespace SOM_RSTDPModel
{
    public static class Som_rstdpModel
    {
        ...
        all-pair model  
            som-stdp&rstdp:   eth80:38 
            som-r-stdp:       eth80:15 
        nearest-pair model
            som-stdp&rstdp:   eth80:25 
            som-r-stdp:       eth80:25
        /--------------------r-stdp stage learning epoch---------------------------------------*/
        public static int RSTDP_EP = 38;
        ...
        /*
        //MNIST
        public const string TrainCodingSpikePath = Path + "mnist_train_coding.txt";
        public const string TrainLabelPath = Path + "mnist_train_label.txt";
        public const string TestCodingSpikePath = Path + "mnist_test_coding.txt";
        public const string TestLabelPath = Path + "mnist_test_label.txt";
        public static int ImageOffest = 6000;
        public static int TrainNum = 6000;
        public static int TestNum = 10000;
        public static int MNISTTrainNum = 60000;
        public static int MNISTTestNum = 10000;
        ...
        */
        ...
        /*
         //orl
         public const string TrainCodingSpikePath = Path + "orl_face_train_coding.txt";
         public const string TrainLabelPath = Path + "orl_face_train_label.txt";
         public const string TestCodingSpikePath = Path + "orl_face_test_coding.txt";
         public const string TestLabelPath = Path + "orl_face_test_label.txt";
         public static int ImageOffest = 6;
         public static int TrainNum = 6;
         public static int TestNum = 40;
         public static int MNISTTrainNum = 60;
         public static int MNISTTestNum = 40;
         public static int MAX_EPOCH = 10;
        */
        ...
        */
        ...
        /*
         //Fashion-MNIST
         public const string TrainCodingSpikePath = Path + "fashion_mnist_train_coding.txt";
         public const string TrainLabelPath = Path + "fashion_mnist_train_label.txt";
         public const string TestCodingSpikePath = Path + "fashion_mnist_test_coding.txt";
         public const string TestLabelPath = Path + "fashion_mnist_test_label.txt";
         public static int ImageOffest = 6000;
         public static int TrainNum = 6000;
         public static int TestNum = 10000;
         public static int MNISTTrainNum = 60000;
        ...
        //eth80
        public const string TrainCodingSpikePath = Path + "eth80_train_coding.txt";
        public const string TrainLabelPath = Path + "eth80_train_label.txt";
        public const string TestCodingSpikePath = Path + "eth80_test_coding.txt";
        public const string TestLabelPath = Path + "eth80_test_label.txt";
        public static int ImageOffest = 328;
        public static int TrainNum = 328;  
        public static int TestNum = 984;
        public static int MNISTTrainNum = 2296;
        public static int MNISTTestNum = 984;
        public static int MAX_EPOCH = 7;
        

        /*
        //posture dvs
        public const string TrainCodingSpikePath = Path + "posture_train_coding.txt";
        public const string TrainLabelPath = Path + "posture_train_label.txt";
        public const string TestCodingSpikePath = Path + "posture_test_coding.txt";
        public const string TestLabelPath = Path + "posture_test_label.txt";
        public static int ImageOffest = 1937;
        public static int TrainNum = 1937;
        public static int TestNum = 5269;
        public static int MNISTTrainNum = 19370;
        public static int MNISTTestNum = 5269;
        public static int MAX_EPOCH = 10;
        */

        /*
        //card dvs
        public const string TrainCodingSpikePath = Path + "cards_train_coding.txt";
        public const string TrainLabelPath = Path + "cards_train_label.txt";
        public const string TestCodingSpikePath = Path + "cards_test_coding.txt";
        public const string TestLabelPath = Path + "cards_test_label.txt";
        public static int ImageOffest = 62;
        public static int TrainNum = 62;
        public static int TestNum = 46;
        public static int MNISTTrainNum = 187;
        public static int MNISTTestNum = 46;
        public static int MAX_EPOCH = 3;
        */
        ...
        ////做深层时的脉冲数据的存储
        //public static int[][] RstdpTrainSpike = new int[MNISTTrainNum][];
        //public static int[][] RstdpTestSpike = new int[MNISTTestNum][];
        ...
        {
            //膜电位
            double[] NeuronMembranePotential = new double[Parameter.OutputLayerNeurons]; //膜电位
            bool InhibitoryTimes; //每个时间步下是否有脉冲输出标志位
            double[] SingleStreamResponse = new double[Parameter.OutputLayerNeurons];  //单张测试图像的神经元响应
            double[] PreSpikeTrace = new double[Parameter.InputLayerNeurons];
            double[] PostSpikeTrace = new double[Parameter.OutputLayerNeurons];
            ...
            for (int EvenSpikeNum = 0; EvenSpikeNum <= (int)(ImageData.Length / 2); EvenSpikeNum++)  //每张图像事件的个数
            {
                ...
                if(EvenSpikeNum == (int)(ImageData.Length / 2) || ImageData[2 * EvenSpikeNum] != preTime)
                {
                    ...
                    for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
                    {
                        if (output_fire_flag[i] == true)
                        {
                            ...
                            PostSpikeTrace[i] = Parameter.PostExpTable[PostTraceDffTime] * PostSpikeTrace[i] + Parameter.PostTraceAmountChange;
                            ...
                            if (LearnRule == "SOM")  //所有突触后脉冲的学习都放到一个模块里面，直到fifo为空且神经元下标为63时done信号生效
                            {
                                for (int j = 0; j < Parameter.InputLayerNeurons; j++)
                                {
                                    ...
                                    Parameter.WeightTensor[i, j] += Parameter.PositiveLR * (PreSpikeTrace[j] * Parameter.PreExpTable[delta_time]);
                            ...
                            else if (LearnRule == "R_STDP")
                            {
                                for (int j = 0; j < Parameter.InputLayerNeurons; j++)
                                {
                                    ...
                                    if (InputClassLabel == Parameter.NeuronRelativeLabel[i])
                                    {
                                        ...
                                        all-pair model  
                                            som-stdp&rstdp:  eth80:1.0 
                                            som-r-stdp:      eth80:1.0 
                                        nearest-pair model
                                            som-stdp&rstdp:  eth80:1.0 
                                            som-r-stdp:      eth80:1.0 
                                        /--------------------post learning reward lr factor---------------------------------------*/
                                        Parameter.WeightTensor[i, j] += 1.0 * Parameter.PositiveLR * (PreSpikeTrace[j] * Parameter.PreExpTable[delta_time]);  
                                    }
                                    else
                                    {
                                        /*--------------------post learning punish lr factor---------------------------------------/
                                        all-pair model  
                                            som-stdp&rstdp: eth80:0.1 
                                            som-r-stdp:     eth80:1.0 
                                        nearest-pair model
                                            som-stdp&rstdp: eth80:0.1 
                                            som-r-stdp:     eth80:1.0 
                                        /--------------------post learning punish lr factor---------------------------------------*/
                                        Parameter.WeightTensor[i, j] -= 0.1 * Parameter.PositiveLR * (PreSpikeTrace[j] * Parameter.PreExpTable[delta_time]);
                                    }
                                    if (Parameter.WeightTensor[i, j] > Parameter.WeightUpperBound)
                                        Parameter.WeightTensor[i, j] = Parameter.WeightUpperBound;
                                    else if (Parameter.WeightTensor[i, j] < Parameter.WeightLowerBound)
                                ...
                                for (int m = 0; m < Parameter.SOM_COL; m++)
                                {
                                    if (NeuronMembranePotential[k * Parameter.SOM_ROW + m] != Parameter.RestPotential)
                                    {
                                        ...
                                        if (NeuronMembranePotential[k * Parameter.SOM_ROW + m] != Parameter.RestPotential)
                                        {
                                            ...
                                            double InhibitorFactor = Dist * Parameter.inhibitorFactor * (EP + 1);
                                            if (InhibitorFactor > 1.0)
                                                InhibitorFactor = 1.0;
                                            NeuronMembranePotential[k * Parameter.SOM_ROW + m] = NeuronMembranePotential[k * Parameter.SOM_ROW + m] * (1 - InhibitorFactor);
                                        }
                                    }
                                }
                            }
                ...
                if (EvenSpikeNum < (int)(ImageData.Length / 2))
				{
                    ...
                    PreSpikeTrace[ImageData[2 * EvenSpikeNum + 1]] = (Parameter.PreExpTable[PreTraceDffTime] * PreSpikeTrace[ImageData[2 * EvenSpikeNum + 1]]) + Parameter.PreTraceAmountChange;
                    PreSpikeTraceLastUpdateTime[ImageData[2 * EvenSpikeNum + 1]] = ImageData[2 * EvenSpikeNum];
					if (PreSpikeTrace[ImageData[2 * EvenSpikeNum + 1]] > 16.0)
						PreSpikeTrace[ImageData[2 * EvenSpikeNum + 1]] = 16.0;
					//膜电位的更新
					for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
					{
						int VmDffTime = (ImageData[2 * EvenSpikeNum] - preTime);

                        NeuronMembranePotential[i] = (NeuronMembranePotential[i] * Parameter.VmExpTable[VmDffTime]) + Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]];
                        //vth 与 vm的比较
                        if (output_fire_flag[i] == false && (NeuronMembranePotential[i] >= (Parameter.MembraneThreshold + Parameter.DynamicThreshold[i])))
                        {
                           //Console.WriteLine("第{0}个事件开始发射脉冲,发射脉冲的神经元地址为{1}",EvenSpikeNum.ToString(),i.ToString());
                           //Console.ReadKey();
                            ...
                            if (LearnRule == "SOM")
                            {
                                ...
                                if (Parameter.DynamicThreshold[i] > 65536)
                                    Parameter.DynamicThreshold[i] = 65536;
                            }
                            else if (LearnRule == "R_STDP")
                            {
                                //动态阈值
                        ...
                        if (NeuronMembranePotential[i] > 65536)  //加不加没关系
							NeuronMembranePotential[i] = 65536;
					}
					//当突触前脉冲到来时权重的更新
					if (LearnRule == "SOM")
					{
						for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
						{
                            ...
                            Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] -= Parameter.NegativeLR * (PostSpikeTrace[i] * Parameter.PostExpTable[delta_time]);
					...
					else if (LearnRule == "R_STDP")
					{
						for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
						{
                            ...
                            all-pair model  
                                som-stdp&rstdp: eth80:2.5 
                                som-r-stdp:     eth80:1.0
                            nearest-pair model
                                som-stdp&rstdp: eth80:2.0 
                                som-r-stdp:     eth80:1.0 
                            /--------------------pre learning reward lr factor---------------------------------------*/
                            if (InputClassLabel == Parameter.NeuronRelativeLabel[i])
                                Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] -= 2.5 * Parameter.NegativeLR * (PostSpikeTrace[i] * Parameter.PostExpTable[delta_time]);
                            ...
                            /--------------------pre learning punish lr factor---------------------------------------*/
                                ...
                                Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] += 0.1 * Parameter.NegativeLR * (PostSpikeTrace[i] * Parameter.PostExpTable[delta_time]);
							if (Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] > Parameter.WeightUpperBound)
								Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] = Parameter.WeightUpperBound;
							else if (Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] < Parameter.WeightLowerBound)
								Parameter.WeightTensor[i, ImageData[2 * EvenSpikeNum + 1]] = Parameter.WeightLowerBound;
        ...
        public static void SOMTrain(string pattern)
        {
            ...
            for (int externEp = 0; externEp < 1; externEp++) //mnist 1 orl 100 yale 50
            {
            ...
            //动态阈值衰减
            DynamicThreasholdScaling(32 / 256.0);  //mnist 64
            //记录动态阈值
            ...
            for (int i = 0; i < Parameter.LabelNeuronResponse.GetLength(0); i++)
                ...
                {
                    Parameter.LabelNeuronResponse[i, j] = Parameter.LabelNeuronResponse[i, j] / EachLabelNum[j];
                }
...
;           }
        ...
        public static void WeightRandomInit()
        {
            ...
            for (int i = 0; i < Parameter.WeightTensor.GetLength(0);i++)
            {
                for(int j = 0; j < Parameter.WeightTensor.GetLength(1);j++)
                {
                    Parameter.WeightTensor[i, j] = WeightRandomHandle.NextDouble() * WeightFactor;
                    InitWeightRecord.WriteLine(Convert.ToString(Parameter.WeightTensor[i, j]));
                }
            }
        ...
        public static void ExpLookupTable()
        {
            ...
            {
                Parameter.PreExpTable[t] = Math.Exp(-t / Parameter.PreSpike_tao);
                Parameter.PostExpTable[t] = Math.Exp(-t / Parameter.PostSpike_tao);
                Parameter.VmExpTable[t] = Math.Exp(-t / Parameter.V_tao);

                PreTrace_EXP_LUTRecord.WriteLine(Convert.ToString(Parameter.PreExpTable[t]));
                PostTrace_EXP_LUTRecord.WriteLine(Convert.ToString(Parameter.PostExpTable[t]));
                Vm_EXP_LUTRecord.WriteLine(Convert.ToString(Parameter.VmExpTable[t]));
            }
        ...
        //5)标签函数
        public static int[] ClassAssign(double[,] OutputResponseInfo) // 输入100*10的矩阵，即每一个输出神经元对于每一类的响应
        {
            ...
            for (int Neuron = 0; Neuron < OutputResponseInfo.GetLength(0); Neuron++) // 将每个输出神经元对于每一类的总响应先排序，再将响应最大的一类作为标签赋给该神经元
            {
                ...
                for (int ii = 0; ii < OutputResponseInfo.GetLength(1); ii++)// 排序
                {
                    ...
                    for (int jj = ii; jj < OutputResponseInfo.GetLength(1); jj++)
                    {
                        ...
                        {
                            double temp = OutputResponseInfo[Neuron, ii];
        ...
        //6)决策函数
        public static int WinnerDecide(int[] LabelNeuron, int[] EachLabelNeuronNum, double[] OutputResponseInfo, bool R_STDP_Flag)
        {
        ...
        {
            Parameter.LabelNeuronResponse = new double[Parameter.OutputLayerNeurons, Parameter.NumClass]; // 记录每个输出神经元对于标签的响应情况
        ...
        //8)动态阈值缩放
        public static void DynamicThreasholdScaling(double div)
        {
            for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
            {
                Parameter.DynamicThreshold[i] = div * Parameter.DynamicThreshold[i];
            }      
        }
        ...
        {
            for (int i = 0; i < Parameter.OutputLayerNeurons; i++)
                Parameter.DynamicThreshold[i] = (1.0 - 1.0 / tao) * Parameter.DynamicThreshold[i];
        }
        ...
        public static void ReadLabelAndWeightFromRSTDP()
        {
            ...
            {
                //Parameter.DynamicThreshold[count++] = Convert.ToInt32(line_data);
                Parameter.DynamicThreshold[count++] = Convert.ToDouble(line_data);
            }
            watch.Stop();
            Console.WriteLine("读取文件结束，读取文件共消耗 {0} 分钟", (watch.ElapsedMilliseconds / 1000 / 60.0).ToString("F3"));
            watch.Reset();
